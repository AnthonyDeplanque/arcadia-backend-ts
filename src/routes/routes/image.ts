...
import {
  postImageValidationObject,
  updateImageValidationObject,
...
imageRoute.post('/', (req, res) =>
  postController(req, res, table, postImageValidationObject)
);
imageRoute.put('/:id', (req, res) =>
  updateController(req, res, table, updateImageValidationObject)
);
